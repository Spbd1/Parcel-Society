...
const demoServers = [
  {
    ...
    description: "Demo server for low initial spatial inequality and stable institutions.",
  ...
  },
  {
    ...
    description: "Demo server for low initial spatial inequality and uncertain institutions.",
    inequalityCondition: InequalityCondition.LOW,
  ...
  },
  {
    ...
    description: "Demo server for high initial spatial inequality and stable institutions.",
  ...
  },
  {
    ...
    description: "Demo server for high initial spatial inequality and uncertain institutions.",
    inequalityCondition: InequalityCondition.HIGH,
    uncertaintyCondition: UncertaintyCondition.UNCERTAIN,
